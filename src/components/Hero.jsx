        ...
        <div className="space-y-8 order-2 lg:order-1 text-center lg:text-left opacity-0 animate-fade-in-up">
          ...
          <div className="flex items-center justify-center lg:justify-start gap-6 pt-6 mt-8">
            ...
            <div className="flex gap-5 text-3xl items-center">
              {/* GitHub */}
              <a href="https://github.com/ishusharma-7" target='blank' className="text-gray-200 hover:text-white hover:scale-125 hover:drop-shadow-[0_0_20px_rgba(255,255,255,0.5)] transition-all duration-300">
                <FaGithub />
              </a>
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/in/ishu-sharma-043121325/" target='blank' className="text-[#0A66C2] bg-white rounded-md hover:scale-125 hover:drop-shadow-[0_0_20px_rgba(10,102,194,0.8)] transition-all duration-300 leading-none">
                <FaLinkedin />
              </a>
              {/* Instagram */}
              <a href="https://www.instagram.com/ishu.sharma_7/?__pwa=1" target='blank' className="text-[#E1306C] hover:scale-125 hover:drop-shadow-[0_0_20px_rgba(225,48,108,0.8)] transition-all duration-300">
                <FaInstagram />
              </a>
              {/* Render */}
              <a href="https://dashboard.render.com/" target='blank' className="text-[#46E3B7] hover:scale-125 hover:drop-shadow-[0_0_20px_rgba(70,227,183,0.8)] transition-all duration-300">
                <SiRender />
              </a>
            </div>
          </div>
